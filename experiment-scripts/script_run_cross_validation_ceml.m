...
results_root_path = fullfile(root_path, '/results/cv_results/ceml');
pretrained_results_root_path = fullfile(root_path, 'results/cv_results/ceml');
...
% run cross validation after setting pipeline
% This step is generic as it is run for all methods in the same way
