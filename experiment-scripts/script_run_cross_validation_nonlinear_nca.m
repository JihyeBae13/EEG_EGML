...
results_root_path = fullfile(root_path, 'results/cv_results/nonlinear_nca');
pretrained_results_root_path = fullfile(root_path, 'results/cv_results/nca');
...
%% cross-validation assuming models have been pretrained for lienar SVM
