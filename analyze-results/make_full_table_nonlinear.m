...
for iMtd = 1:length(methods)
    ...
    results_root_path = fullfile('/home/lgsanchez/work/Code/research/bci-eeg/metric-learning-premovement/results/cv_results/', strcat('nonlinear_', methods{iMtd}));
...
writetable(full_test_table, '/home/lgsanchez/work/Code/research/bci-eeg/metric-learning-premovement/results/cv_results/all_test_nonlinear.xlsx','Sheet',1);
